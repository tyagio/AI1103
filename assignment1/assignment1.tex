...
Case 1: \emph{X} = 0
\begin{multline}
\implies \pr{X=0}=\pr{A'B'}=\pr{A'}\times \pr{B'|A'}\\
...
Case 2: \emph{X} = 1
\begin{multline}
    \implies \pr{X=1}=\pr{AB'}+\pr{A'B }\\ 
    \text{In} \pr{AB'}=\pr{A}\times \pr{B'|A}\\\text{there 51 cards and 3 aces left for 2nd draw}\\
    \pr{AB'} = \frac{4}{52} \times \frac{48}{51}=16/221\\  
    \text{In} \pr{A'B}=\pr{A'}\times \pr{B|A'}\\\text{there 51 cards and 4 aces left for 2nd draw}\\
    \pr{A'B} = \frac{48}{52} \times \frac{4}{51}=16/221\\ 
    \implies\pr{X=1}=\frac{16}{221}+\frac{16}{221}=\frac{32}{221}\\
\end{multline}
Case 3: \emph{X} = 2
\begin{multline}
    \implies \pr{X=2}=\pr{AB}=\pr{A}\times\pr{B|A}\\ 
