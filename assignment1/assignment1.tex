...
Case 1: \emph{X} = 0
\begin{align}
\nonumber\implies \pr{X=0}=\pr{A=0,B=0}\\
\nonumber=\pr{A=0}\times \pr{B=0|A=0}\\
\nonumber\pr{X=0} = \frac{48}{52} \times \frac{47}{51}=188/221\\
\end{align}
...
\begin{align}
&\nonumber\implies \pr{X=2}=\pr{A=1,B=1}\\
&\nonumber=\pr{A=1}\times\pr{B=1|A=1}\\ 
&\nonumber\pr{X=2} = \frac{4}{52} \times \frac{3}{51}=1/221\\
\end{align}
