...
Let A denote case when first card drawn is an ace i.e \pr{A}=1/13\\
Let B denote case when second card drawn is an ace(no replacements).A and B not independent\\

Case 1: \emph{X} = 0
\begin{multline}
\implies \pr{X=0}=\pr{A'B'}\\ \text{i.e both selections not ace}\\
...
Case 2: \emph{X} = 1
\begin{multline}
    \implies \pr{X=1}=\pr{AB'}+\pr{A'B}\\ \text{i.e only 1 ace}\\
    \text{In} \pr{AB'}\text{there 51 cards and 3 aces left for 2nd draw}\\
    \pr{AB'} = \frac{4}{52} \times \frac{48}{51}=16/221\\  
    \text{In} \pr{AB'}\text{there 51 cards and 4 aces left for 2nd draw}\\
    \pr{A'B} = \frac{48}{52} \times \frac{4}{51}=16/221\\ 
    \implies\pr{X=1}=\frac{16}{221}+\frac{16}{221}=\frac{32}{221}
\end{multline}
Case 3: \emph{X} = 2
\begin{multline}
    \implies \pr{X=2}=\pr{A'B'}\\ \text{i.e both selections ace}\\
...
\end{multline}    
 ...
 i.e E(X) is given by\[E(X) = {\sum_{i=0}^2 X\times P(X) }\]
